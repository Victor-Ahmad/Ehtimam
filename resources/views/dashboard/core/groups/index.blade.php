                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-2">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">مجموعات الأخصائيين</li>
                            </ol>
                        </nav>
...
@push('script')
    <script type="text/javascript">
        ...
        $(document).on('click', '#edit-techGroup', function() {
            ...
            technician_group_id.forEach(element => {
                $("#technician_group_id option[value='" + element + "']").attr("selected", true).trigger(
                    'change');
            });

            $("#country_id option[value='" + country_id + "']").attr("selected", true);
            $("#city_id option[value='" + city_id + "']").attr("selected", true);
            $("#gender_id option[value='" + gender_id + "']").attr("selected", true).trigger('change');
