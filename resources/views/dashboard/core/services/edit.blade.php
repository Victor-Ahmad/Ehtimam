                                ...
                                <div class="form-row mb-2">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="title_ar" class="form-control" id="inputEmail4"
                                            value="{{ $service->title_ar }}" placeholder="{{ __('dash.title_ar') }}">
                                        @error('title_ar')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="title_en" class="form-control" id="inputEmail4"
                                            value="{{ $service->title_en }}" placeholder="{{ __('dash.title_en') }}">
                                        @error('title_en')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-row mb-2">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select id="gender" class="select2 form-control pt-1" name="gender" required>
                                            ...
                                            <option @if ($service->gender == 'male') selected @endif value="male">
                                                {{ __('dash.males') }}</option>
                                            <option @if ($service->gender == 'female') selected @endif value="female">
                                                {{ __('dash.females') }}</option>
                                        </select>
                                        @error('gender')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                        ...
                                        <select id="category_id" class="select2 form-control pt-1" name="category_id">
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}"
                                                    @if ($category->id == $service->category_id) selected @endif>
                                ...
                                <div class="form-row mb-2">
                                    ...
                                    <div
                                        ...
                                        <select id="inputState" class="select2 type form-control" name="type">
                                            <option value="{{ \App\Enums\Core\ServiceType::fixed()->value }}"
                                                @if (\App\Enums\Core\ServiceType::fixed()->value == $service->type) selected @endif>
                                                {{ \App\Enums\Core\ServiceType::fixed()->value }}</option>
                                            <option value="{{ \App\Enums\Core\ServiceType::evaluative()->value }}"
                                                @if (\App\Enums\Core\ServiceType::evaluative()->value == $service->type) selected @endif>
                                    ...
                                    <div
                                        ...
                                        <input type="text" name="price" class="form-control" id="inputEmail4"
                                            value="{{ $service->price }}" placeholder="{{ __('dash.price') }}">
                                        @error('price')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group start_from @if ($service->type == 'evaluative') col-md-4 @else col-md-6 @endif"
                                ...
                                <div class="form-row mb-2">
                                        ...
                                        <select id="icon_ids" multiple class="select2 form-control pt-1"
                                            ...
                                            @foreach ($icons as $icon)
                                                <option value="{{ $icon->id }}"
                                                    @if (in_array(
                                                            $icon->id,
                                                            $service->icons()->pluck('icon_id')->toArray())) selected @endif>{{ $icon->title }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('icon_ids')
                                        ...
                                        <select id="measurement_id" class="select2 form-control pt-1"
                                            ...
                                            @foreach ($measurements as $measurement)
                                                <option value="{{ $measurement->id }}"
                                                    @if ($measurement->id == $service->measurement_id) selected @endif>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <label class="switch s-outline s-outline-info  mb-4 mx-4 mt-3 d-block w-50">
                                            ...
                                            <input type="checkbox" name="is_quantity" id="is_quantity"
                                                @if ($service->is_quantity == 1) checked @endif>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <label class="switch s-outline s-outline-info  mb-4 mx-4 mt-3 d-block w-50">
                                            ...
                                            <input type="checkbox" name="best_seller" id="best_seller"
                                                @if ($service->best_seller == 1) checked @endif>
                                            <span class="slider round"></span>
                                        </label>
                                        @error('best_seller')
                                            <div class="alert alert-danger">{{ $message }}</div>
