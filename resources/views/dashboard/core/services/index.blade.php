            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <div class="col-md-12 text-right mb-3">
                        ...
                        <a href="{{ route('dashboard.core.service.create') }}" id=""
                            class="btn btn-primary card-tools">
                            {{ __('dash.add_new') }}
                        </a>
        ...
        $(document).ready(function() {
            $('#html5-extension').DataTable({
                ...
                "oLanguage": {
                    ...
                    'sInfo': "{{ __('dash.Showing') }}" + ' _START_ ' + "{{ __('dash.to') }}" +
                        ' _END_ ' + "{{ __('dash.of') }}" + ' _TOTAL_ ' + "{{ __('dash.entries') }}",
                ...
                success: function(response) {
                    if (response.length > 0) {
                        ...
                        $.each(response, function(key, val) {
                            ...
                            <a data-fancybox="gallery" href="${temp}/` + val['image'] +
                                `"><img class="card-img-top" style="width: 111px;"  src="${temp}/` +
                                val['image'] + `"  alt="Card image cap"></a>
                        <div class="card-body">
