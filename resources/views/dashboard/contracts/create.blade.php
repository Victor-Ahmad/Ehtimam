                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-2">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{route('dashboard.contracts.index')}}">{{__('dash.packages')}}</a></li>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6" style="min-height: 400px;">
                    <div class="col-md-12 text-left mb-3">
                        <h3>إنشاء تقاول جديد</h3>
                    </div>
                    <div class="col-md-12">
                        <form action="{{route('dashboard.contracts.store')}}" method="post" class="form-horizontal"
                            ...
                            <div class="box-body">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select required class="select2 form-control pt-1"
                                            ...
                                            @foreach($ContractPackages as $key => $ContractPackage)
                                                <option value="{{$key}}">{{$ContractPackage}}</option>
                                            @endforeach
                                        </select>
                                        @error('package_id')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                ...
                                <div class="form-row mb-3">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input required name="start_date" type="date" class="form-control datepicker"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input required name="end_date" type="date" class="form-control datepicker"
                                               data-date-format="dd/mm/yyyy">
                                        @error('end_date')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
