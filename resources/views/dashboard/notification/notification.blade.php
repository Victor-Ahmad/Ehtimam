                        ...
                        <form action="{{ route('dashboard.notification.sendNotification') }}" method="post"
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-row mb-3">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="gender_filter">الفئة</label>
                                        <select class="select2 gender_filter form-control" name="gender_filter">
                                    ...
                                    {{-- <div class="form-group col-md-4 div-customer">
                                    ...
                                    <div class="form-group col-md-4  div-technician" style="display:none;">
                                        <label for="technician_id">الفنيين</label>
                                        <select class="form-control technician_id" disabled
                                            style="width: 100%; padding: 8px" name="technician_id">
                                            <option value="all" selected>الكل</option>
