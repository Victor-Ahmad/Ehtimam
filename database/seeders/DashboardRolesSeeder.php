...
class DashboardRolesSeeder extends Seeder
{
    ...
    private function setupPermissions()
    {
        ...
        $permissions = collect([
            ...
            ['name'=>'technicians', 'name_en' => 'technicians', 'name_ar' => 'الأخصائيين'],
            ['name'=>'create_technicians', 'name_en' => 'create technicians', 'name_ar' => 'إنشاء الأخصائيين'],
            ['name'=>'update_technicians', 'name_en' => 'update technicians', 'name_ar' => 'تعديل الأخصائيين'],
            ['name'=>'delete_technicians', 'name_en' => 'delete technicians', 'name_ar' => 'حذف الأخصائيين'],
            ['name'=>'view_technicians', 'name_en' => 'view technicians', 'name_ar' => 'عرض الأخصائيين'],
